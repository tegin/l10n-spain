...
class TestL10nEsFacturae(common.TransactionCase):
    ...
    def test_facturae_generation(self):
        ...
        self.assertFalse(
            generated_facturae.xpath(
                ...
                'RelatedDocuments/Attachments', namespaces={'fe': fe}),
        )
    ...
    def test_facturae_with_attachments(self):
        ...
        generated_facturae = etree.fromstring(
            base64.b64decode(self.wizard.facturae))
        import logging
        logging.info(etree.tostring(generated_facturae, pretty_print=True))
        fe = 'http://www.facturae.es/Facturae/2009/v3.2/Facturae'
        self.assertTrue(
            generated_facturae.xpath(
                '/fe:Facturae/Invoices/Invoice/AdditionalData/'
                'RelatedDocuments', namespaces={'fe': fe}),
        )
        self.assertTrue(
            generated_facturae.xpath(
                '/fe:Facturae/Invoices/Invoice/AdditionalData/'
                'RelatedDocuments/Attachment', namespaces={'fe': fe}),
        )
