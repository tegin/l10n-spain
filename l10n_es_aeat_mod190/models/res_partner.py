...
class ResPartner(models.Model):
    _name = 'res.partner'
    _inherit = ['res.partner', 'l10n.es.mod190.mixin']
    ...
    discapacidad = fields.Selection([
        ('0',
         '0 - Sin discapacidad o grado de minusvalía inferior al 33 por 100.'),
        ('1',
         '1 - Grado de minusvalía superior al 33 por 100 e inferior '
         'al 66 por 100.'),
        ('2', '2 - Grado de minusvalía superior al 33 por 100 e inferior '
    ...
    contrato_o_relacion = fields.Selection([
        ...
        string='Contrato o relacion', size=1,
